...
* [FigmaToCode](https://github.com/bernaferrari/FigmaToCode) ⭐ 5,150 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-05 - Generate responsive pages and apps on Tailwind, Flutter and SwiftUI.
...
* [figma-plugins-on-github](https://github.com/thomas-lowry/figma-plugins-on-github) ⭐ 837 | 🐛 10 | 📅 2026-07-17 - A list of Figma Plugins that have been shared on GitHub.
...
* [figma-linux](https://github.com/ChugunovRoman/figma-linux) ⭐ 3,258 | 🐛 162 | 🌐 Svelte | 📅 2026-01-21 - Figma electron app (unofficial).
